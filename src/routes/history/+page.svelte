<script>
    import { Clock, ArrowRight, Calendar, Layers } from "lucide-svelte";
    let { data } = $props();
</script>
...
<div class="max-w-4xl mx-auto px-4 py-12">
    ...
    {#if data.specs.length === 0}
        ...
        >
            ...
            <h2 class="text-2xl font-bold text-white mb-4">No specs found</h2>
            <p class="text-gray-400 mb-8 max-w-sm mx-auto">
                You haven't generated any specs yet. Start by describing your
                feature idea.
            </p>
            <a
                href="/new"
